      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo site_url('C_hargagaram')?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="harga" name="harga" value="<?php echo $harga->barang.' / '.$harga->kategori.' / '.$harga->merk ?>" readonly>
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                  <div class="col-sm-10">
                    <a href="<?php echo site_url('C_hargagaram/index'); ?>" class="btn btn-default">Kembali</a>
                  </div>
              </div>
              <!-- /.box-footer -->
            </form>

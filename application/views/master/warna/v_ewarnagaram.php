      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo site_url('C_warnagaram/editwarna')?>">
              <div class="box-body">
              ...
              <div class="box-footer">
                  <div class="col-sm-10">
                    <a href="<?php echo site_url('C_warnagaram/add'); ?>" class="btn btn-default">Batal</a>

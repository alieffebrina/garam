                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <a href="<?php echo site_url('C_satuan/hapus/'.$satuan->id_satuan); ?>" onclick="return confirm('Yakin Hapus?')"><button type="button" class="btn btn-danger"><i class="fa fa-fw fa-trash-o"></i></button></a>
                    </div>
                  </td>
                </tr>
                  <?php } ?>
